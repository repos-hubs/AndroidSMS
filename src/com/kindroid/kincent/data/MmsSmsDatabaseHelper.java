...
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_DELIVERY_IND;
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND;
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_READ_ORIG_IND;
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_READ_REC_IND;
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF;
import static com.kindroid.google.android.mms.pdu.PduHeaders.MESSAGE_TYPE_SEND_REQ;
...
import com.kindroid.android.provider.Telephony.Sms;
import com.kindroid.android.provider.Telephony.Threads;
...
import com.kindroid.android.provider.Telephony.MmsSms.PendingMessages;
...
public class MmsSmsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createCommonTables(SQLiteDatabase db) {
         ...
         */
        db.execSQL("CREATE TABLE pending_msgs" +" (" +
