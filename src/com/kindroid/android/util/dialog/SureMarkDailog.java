...
public class SureMarkDailog extends Dialog implements View.OnClickListener {
	...
	private void findView() {
		...
		mContentTv.setText(getContext().getString(
		...
		case R.id.sure_tv:
			...
			for (int i = 0; i < messages.size(); i++) {
				...
				if (msg.isSelected()) {
					...
					MessengerUtils.setThreadRead(getContext(), threadId,
							msg.isSelected());
				}
			}
	...
	public SureMarkDailog(Context context, int theme) {
		super(context, theme);
	}
