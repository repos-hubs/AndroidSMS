...
public class SureDelCategoryDailog extends Dialog implements View.OnClickListener {
	...
	private void findView(){
	    ...
	    mContentTv.setText(getContext().getString(R.string.sure_del_the_category));
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.sure_tv:
			CollectionDataBase.get(getContext()).delCategory(id);
	...
	public SureDelCategoryDailog(Context context, int theme) {
		super(context, theme);
	}
