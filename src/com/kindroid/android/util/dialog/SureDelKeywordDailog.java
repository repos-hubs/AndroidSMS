...
public class SureDelKeywordDailog extends Dialog implements
	...
	private void findView() {
		...
		mContentTv.setText(getContext().getString(R.string.sure_del_the_keyword));
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.sure_tv:
			String keyword = c.getString(c.getColumnIndex(InterceptDataBase.KEYWORDZH));
			InterceptDataBase.get(getContext()).deleteKeyword(keyword, 1);
			c.requery();
			dismiss();
			break;
		case R.id.cancel_tv:
	...
	public SureDelKeywordDailog(Context context, int theme,Cursor c) {
		super(context, theme);
		this.c=c;
