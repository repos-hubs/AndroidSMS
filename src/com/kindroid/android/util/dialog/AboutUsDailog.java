...
public class AboutUsDailog extends Dialog implements View.OnClickListener {
	private TextView mSureTv,mCancelTv,mTitleTv,mContentTv;
	private NativeCursor nc;
	private int type;
	private static final String LAYOUT_FILE = "about_us_dialog";
	@Override
	...
	public AboutUsDailog(Context context, int theme) {
		super(context, theme);
	}
