...
public class AddBlackWhiteListDialogAdapter extends BaseAdapter {
	private int mStringId[];
	private Context context;

	private static final String LAYOUT_FILE = "more_dialog_item";
	public AddBlackWhiteListDialogAdapter(Context context, int stringId[]) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextPaint tp=appTextView.getPaint();
